...
public class AccountBalanceApp {
	public static void main(String[] args) {
		...
		System.out.println("Starting Account Balance: ");
		printBalances(ca, cf);
	...
	private static void printBalances(CheckingAccount ca, NumberFormat cf) {
		System.out.println("Checking Account:  " + cf.format(ca.getBalance()));
		System.out.println("Savings Account:  " + cf.format(ca.getBalance()));
	}
